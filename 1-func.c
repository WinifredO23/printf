...
{
	int i = BUFF_SIZE - 2;
	unsigned long int num = va_arg(specifiers, unsigned long int);
...
int print_hexadecimal(va_list specifiers, char buffer[],
		int flags, int width, int precision, int size)
{
	return (print_hexa(specifiers, "0123456789abcdef", buffer,
 ...
 * Return: Number of chars printed
 */
int print_hexa(va_list specifiers, char map_to[], char buffer[],
